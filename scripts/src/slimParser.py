...
def runSlim(recipe,wStrength,sStrength,N,pposL,pposH,bgsMutRate,output,iteration):
    """
...
def inputSlim(iterations,recipe,wStrength,sStrength,N,pposL,pposH,bgsMutRate,output):
    ...
    inp = list(zip(irecipe,iwStrength,isStrength,iN,ipposL,ipposH,ibgsMutRate,ioutput,total))
